...
const SearchBar = () => {
  ...
  return (
    <div className="flex justify-center w-full pt-5">
      ...
      <select id="category" defaultValue="" onChange={handleCategoryChange} className="fl text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
